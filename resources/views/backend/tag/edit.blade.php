...
@section('content')
    ...
    <section class="content">
        <div class="form-group">
            <form action="{{route('tag.update',$tag->tags_id)}}" method="post">
                @csrf
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="slug" value="{{$tag->created_by}}">
                    </div>
                </div>
                <div class="form-group row">
                    <label for="slug" class="col-sm-2 col-form-label">Updated_by</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="slug" value="{{$tag->updated_by}}">
                    </div>
                </div>
